    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regenerate_stack', models.BooleanField(blank=True, default=False, help_text='Flag indicating that Stack Answersheet is using to make questions should be regenerated')),
                ('clear_excluded', models.BooleanField(blank=True, default=False, help_text='Flag indicating that Stack Answersheet is using to make questions should clear its Excluded field. It leads to Answersheet using all Words from Stack.')),
                ('review', models.BooleanField(blank=True, default=False, help_text='Flag indicating that generated Answersheet will be used for review and correctly answered questions will not be excluded from Stack.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Time of creation')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Last update time')),
                ('language', models.CharField(choices=[('KY', 'KYRGYZ'), ('EN', 'ENGLISH'), ('RU', 'RUSSIAN')], max_length=2)),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='stacks', to='dance.collection')),
                ('excluded_words', models.ManyToManyField(blank=True, related_name='stacks_excluded', to='dance.word')),
                ('learner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stack', to='dance.learner')),
                ('words', models.ManyToManyField(blank=True, related_name='stacks', to='dance.word')),
            ],
            options={
